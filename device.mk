...
PRODUCT_COPY_FILES += \
    hardware/qcom-caf/sdm845/audio/configs/sdm710/audio_tuning_mixer.txt:$(TARGET_COPY_OUT_VENDOR)/etc/audio_tuning_mixer.txt \
    hardware/qcom-caf/sdm845/audio/configs/sdm710/audio_tuning_mixer_tasha.txt:$(TARGET_COPY_OUT_VENDOR)/etc/audio_tuning_mixer_tasha.txt \
    hardware/qcom-caf/sdm845/audio/configs/sdm710/audio_tuning_mixer_tavil.txt:$(TARGET_COPY_OUT_VENDOR)/etc/audio_tuning_mixer_tavil.txt \
    hardware/qcom-caf/sdm845/audio/configs/sdm710/graphite_ipc_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/graphite_ipc_platform_info.xml \
    hardware/qcom-caf/sdm845/audio/configs/sdm710/listen_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/listen_platform_info.xml \
...
PRODUCT_PACKAGES += \
    ...
    android.hardware.biometrics.fingerprint@2.1-service.nokia_sdm710 \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/idc/gpio-keys.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/gpio-keys.kl 
...
#OZO_AUDIO
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/ozo_config.xml:$(TARGET_COPY_OUT_VENDOR)/etc/ozo_config.xml \
